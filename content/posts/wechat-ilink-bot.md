+++
title = "微信 ClawBot：首个官方个人号 Bot API 协议拆解与实战"
date = "2026-03-22T23:44:37+08:00"
author = "x1ah"
authorTwitter = ""
cover = ""
tags = ["微信", "Bot", "Node.js"]
keywords = ["微信 ClawBot", "iLink", "OpenClaw", "微信机器人", "Bot API"]
description = "从 OpenClaw 插件到独立 Bot，完整实现微信官方机器人 iLink API 对接"
showFullContent = false
+++

> 从 OpenClaw 插件到独立 Bot，完整实现微信官方机器人 API 对接

配套代码：[x1ah/wechat-ilink-demo](https://github.com/x1ah/wechat-ilink-demo)
...
```bash
git clone https://github.com/x1ah/wechat-ilink-demo.git
...
完整可运行代码见 [bot.mjs](https://github.com/x1ah/wechat-ilink-demo/blob/master/bot.mjs)。
